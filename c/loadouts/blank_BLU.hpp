...
// Camo set
#define CAMO_UNIFORM "vn_b_uniform_macv_04_01", "vn_b_uniform_macv_06_01", "vn_b_uniform_macv_02_01"
#define CAMO_VEST "vn_b_vest_usarmy_02", "vn_b_vest_usarmy_05"
#define CAMO_BACKPACK "vn_b_pack_lw_01_m16_pl", "vn_b_pack_lw_01_m79_pl"
...
class engl: eng {// Logistics Leader
  ...
  items[] += {LEADER_TOOLS};
  linkedItems[] += {LEADER_LINKED,BINOS};
  backpackItems[] += {RADIO_MR,RADIO_LR};
};
